	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (thisTouchAllowed(ev)) {
				Log.e("log","onInterceptTouchEvent thisTouchAllowed");
...
//			break;
	...
	public boolean onTouchEvent(MotionEvent ev) {
		Log.e("log","onTouchEvent start");
		if (!mEnabled)
			return false;

		Log.e("log","onTouchEvent thisTouchAllowed"+thisTouchAllowed(ev));
		...
		//			return false;
		Log.e("log","onTouchEvent thisTouchAllowed");
